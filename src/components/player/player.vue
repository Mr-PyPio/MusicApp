        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar :percent="percent" @percentChange="onProgressBarChange" :lyricReady="lyricReady">
              </progress-bar>
            </div>
          ...
          <div class="operators">
            ...
            <div class="icon i-right" @click.stop>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      disableCls() {
        return (this.songReady && this.lyricReady) ? '' : 'disable'
      },
      percent() {
